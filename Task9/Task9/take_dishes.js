...
export function setSelectedItems() {
    ...
    const types = ["soup", "main-course", "salad", "drink", "dessert"];
    const foodPoints = document.querySelectorAll(".food-point");
    types.forEach(type => {
        if (window.localStorage.getItem(type) !== null) {
            foodPoints.forEach((food) => {
                if (window.localStorage.getItem(type) === food.getAttribute("data-id")) {
                    food.classList.add("selected");
                    if (type === "soup") {
                        document.getElementById("input-soup").value = food.getAttribute("data-dish");
                    } else if (type === "main-course") {
                        document.getElementById("input-main-course").value = food.getAttribute("data-dish");
                    } else if (type === "salad") {
                        document.getElementById("input-salad").value = food.getAttribute("data-dish");
                    } else if (type === "drink") {
                        document.getElementById("input-drink").value = food.getAttribute("data-dish");
                    } else if (type === "dessert") {
                        document.getElementById("input-dessert").value = food.getAttribute("data-dish");
                    }
                }
            });
        }
